...
//                    case .finished:
//                        msg = "finished"
//                        XCTAssertEqual(redBlackTree.count(), self.treeConfigurableAccounts.count)
//                        XCTAssertFalse(redBlackTree.isEmpty())
//                        XCTAssertEqual(redBlackTree.allElements().count, self.treeConfigurableAccounts.count)
//                        break
//                    case .failure(_):
//                        msg = "failure"
//                        break
...
//                    case .finished:
//                        msg = "finished"
//                        XCTAssertEqual(redBlackTree2.count(), self.treeConfigurableReceipts.count)
//                        XCTAssertFalse(redBlackTree2.isEmpty())
//                        XCTAssertEqual(redBlackTree2.allElements().count, self.treeConfigurableReceipts.count)
//                        break
//                    case .failure(_):
//                        msg = "failure"
//                        break
...
//                    case .finished:
//                        msg = "finished"
//                        XCTAssertEqual(redBlackTree3.count(), self.treeConfigurableTransactions.count)
//                        XCTAssertFalse(redBlackTree3.isEmpty())
//                        XCTAssertEqual(redBlackTree3.allElements().count, self.treeConfigurableTransactions.count)
//                        break
//                    case .failure(_):
//                        msg = "failure"
//                        break
